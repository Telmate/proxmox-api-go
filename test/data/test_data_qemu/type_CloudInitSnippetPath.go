...
func CloudInitSnippetPath_Character_Illegal() []string {
	return []string{
		...
		"JjKkLl-MmNnOo.PpQ)qRrSsTtUuVvWwXxYyZz01",
		"A->1",
		"B-2<_C-3",
		"D-4_?E-5-F-6",
		"G-7-H/-8*-I-9",
...
func CloudInitSnippetPath_Max_Legal() string {
	return "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/- _.abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/- _.abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/- _.abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ012"
}

// 257 invalid characters
func CloudInitSnippetPath_Max_Illegal() string {
	return CloudInitSnippetPath_Max_Legal() + "A"
}

// 1 valid characters
func CloudInitSnippetPath_Min_Legal() string {
	return CloudInitSnippetPath_Min_Illegal() + "a"
}
...
func CloudInitSnippetPath_Legal() []string {
	return []string{
		...
		CloudInitSnippetPath_Max_Legal(),
		CloudInitSnippetPath_Min_Legal(),
	}
}

func CloudInitSnippetPath_InvalidPath() string {
	return "yhfg8fiusfhis/fmdjfhsudf//dsad"
}
