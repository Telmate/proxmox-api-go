...
func (raw *rawConfigLXC) GetBootMount() *LxcBootMount { return raw.getBootMount(raw.isPrivileged()) }
...
func (raw *rawConfigLXC) GetMounts() LxcMounts { return raw.getMounts(raw.isPrivileged()) }
