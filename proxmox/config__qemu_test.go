...
func Test_ConfigQemu_get(t *testing.T) {
	...
	tests := []struct {
		...
		{category: `CPU`,
			tests: testData_ConfigQemu_CPU_Get()},
		{category: `CloudInit`,
			tests: []qemuTestCaseGet{
				{name: `ALL`,
		...
		{category: `USBs`,
			tests: testData_ConfigQemu_USB_Get()},
		{category: `watchdog`,
			...
			valid: qemuTestTypeValidate{
				createUpdate: []qemuTestCaseValidate{
					...
					{name: `Type host`,
						...
						current: &ConfigQemu{CPU: &QemuCPU{}}},
					{name: `Units Minimum`,
						input:   baseConfig(ConfigQemu{CPU: &QemuCPU{Units: util.Pointer(QemuCpuUnits(0))}}),
						current: &ConfigQemu{CPU: &QemuCPU{}}},
					{name: `Units Maximum`,
						input:   baseConfig(ConfigQemu{CPU: &QemuCPU{Units: util.Pointer(QemuCpuUnits(262144))}}),
						current: &ConfigQemu{CPU: &QemuCPU{}}}},
				update: []qemuTestCaseValidate{
					{name: `nothing`,
						input:   baseConfig(ConfigQemu{CPU: &QemuCPU{}}),
			...
			invalid: qemuTestTypeValidate{
				...
				createUpdate: []qemuTestCaseValidate{
					...
					{name: `errors.New(CpuUnits_Error_Maximum)`,
						input:   baseConfig(ConfigQemu{CPU: &QemuCPU{Units: util.Pointer(QemuCpuUnits(262145))}}),
						current: &ConfigQemu{CPU: &QemuCPU{}},
