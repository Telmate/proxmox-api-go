...
func Test_ConfigQemu_mapToApiValues(t *testing.T) {
	...
	tests := []struct {
			...
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{
				...
				Bandwidth: QemuDiskBandwidth{
					Data: QemuDiskBandwidthData{
						ReadLimit:  QemuDiskBandwidthDataLimit{Burst: float99, Concurrent: float10},
						WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79, Concurrent: float45},
					},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.ReadLimit.BurstDuration",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.WriteLimit.BurstDuration",
