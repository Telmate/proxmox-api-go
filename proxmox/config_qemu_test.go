...
func Test_ConfigQemu_mapToApiValues(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Create Disks.Ide.Disk_X.Disk Create Gibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Size:    33554432,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.Ide.Disk_X.Disk Create Kibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Size:    33554433,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.Sata.Disk_X.Disk Create Gibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{
				Size:    16777216,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.Sata.Disk_X.Disk Create Kibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{
				Size:    16777217,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.Scsi.Disk_X.Disk Create Gibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_0: &QemuScsiStorage{Disk: &QemuScsiDisk{
				Size:    76546048,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.Scsi.Disk_X.Disk Create Kibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_0: &QemuScsiStorage{Disk: &QemuScsiDisk{
				Size:    76546049,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk Create Gibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_0: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
				Size:    8238661632,
				Storage: "Test",
			}}}}},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk Create Kibibyte",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_0: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
				Size:    8238661633,
				Storage: "Test",
			}}}}},
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN Gibibyte File",
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN Gibibyte File LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN Gibibyte Volume",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Id:      23,
				Size:    9437185,
				Storage: "test",
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN Gibibyte Volume LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
				Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Disk: &QemuIdeDisk{
					Id:           23,
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN Kibibyte File",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    9437186,
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN Gibibyte File",
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN Gibibyte File LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN Gibibyte Volume",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{
				Id:      23,
				Size:    9437185,
				Storage: "test",
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN Gibibyte Volume LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
				Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{
					Id:           23,
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN Kibibyte File",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    9437186,
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN Gibibyte File",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN Gibibyte File LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN Gibibyte Volume",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_18: &QemuScsiStorage{Disk: &QemuScsiDisk{
				Id:      23,
				Size:    9437185,
				Storage: "test",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN Gibibyte Volume LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
				Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_18: &QemuScsiStorage{Disk: &QemuScsiDisk{
					Id:           23,
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN Kibibyte File",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_18: &QemuScsiStorage{Disk: &QemuScsiDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    9437186,
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN Gibibyte File",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN Gibibyte File LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN Gibibyte Volume",
			currentConfig: ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_2: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
				Id:      23,
				Size:    9437185,
				Storage: "test",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN Gibibyte Volume LinkedClone",
			currentConfig: ConfigQemu{
				LinkedVmId: 100,
				Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_2: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
					Id:           23,
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN Kibibyte File",
			currentConfig: ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_2: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    9437186,
...
func Test_ConfigQemu_mapToStruct(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Disks Ide Passthrough size G",
		...
		{name: "Disks Ide Passthrough size K",
		...
		{name: "Disks Ide Passthrough size M",
		...
		{name: "Disks Ide Passthrough size T",
		...
		{name: "Disks Sata Passthrough size G",
		...
		{name: "Disks Sata Passthrough size K",
		...
		{name: "Disks Sata Passthrough size M",
		...
		{name: "Disks Sata Passthrough size T",
		...
		{name: "Disks Scsi Passthrough size G",
		...
		{name: "Disks Scsi Passthrough size K",
		...
		{name: "Disks Scsi Passthrough size M",
		...
		{name: "Disks Scsi Passthrough size T",
		...
		{name: "Disks VirtIO Passthrough size G",
		...
		{name: "Disks VirtIO Passthrough size K",
		...
		{name: "Disks VirtIO Passthrough size M",
		...
		{name: "Disks VirtIO Passthrough size T",
