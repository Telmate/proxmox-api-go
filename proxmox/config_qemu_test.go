...
func Test_ConfigQemu_mapToApiValues(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Update Disk.Ide.Disk_X.Disk SAME",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: ideBase}}},
			config:        &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: ideBase}}},
		...
		{name: "Update Disk.Sata.Disk_X.Disk SAME",
			...
			config:        &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_2: sataBase}}},
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk SAME",
			...
			config:        &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_4: virtioBase}}},
