...
func Test_ConfigQemu_mapToApiValues(t *testing.T) {
	...
	float10 := QemuDiskBandwidthDataLimitConcurrent(10.3)
	float45 := QemuDiskBandwidthDataLimitConcurrent(45.23)
	float79 := QemuDiskBandwidthDataLimitBurst(79.23)
	float99 := QemuDiskBandwidthDataLimitBurst(99.2)
	...
	tests := []struct {
		...
		{name: "Create Disks.Ide.Disk_X.Disk All",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{
				...
				Bandwidth: QemuDiskBandwidth{
					Data: QemuDiskBandwidthData{
						ReadLimit:  QemuDiskBandwidthDataLimit{Concurrent: float10, Burst: float99},
						WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45, Burst: float79},
					},
					Iops: QemuDiskBandwidthIops{
						ReadLimit:  QemuDiskBandwidthIopsLimit{Concurrent: uint34, Burst: uint78},
						WriteLimit: QemuDiskBandwidthIopsLimit{Concurrent: uint23, Burst: uint89},
					},
				},
			...
			output: map[string]interface{}{"ide0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=558485ef-478,ssd=1"},
		},
		...
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"ide0": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"ide1": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"ide2": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_3: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"ide3": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"ide0": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"ide1": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Disk.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Disk: &QemuIdeDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
		...
		{name: "Create Disks.Ide.Disk_X.Passthrough All",
			...
			output: map[string]interface{}{"ide0": "/dev/disk/by-id/scsi-0QEMU_QEMU_HARDDISK_drive-scsi8,aio=threads,cache=unsafe,discard=on,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=test-serial_757465-gdg,ssd=1"},
		},
		...
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"ide0": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"ide1": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"ide2": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_3: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"ide3": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_0: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"ide0": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"ide1": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Ide.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_2: &QemuIdeStorage{Passthrough: &QemuIdePassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
		...
		{name: "Create Disks.Sata.Disk_X.Disk ALL",
			...
			output: map[string]interface{}{"sata0": "Test:32,aio=native,cache=unsafe,discard=on,format=qcow2,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=ab_C-12_3,ssd=1"},
		},
		...
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_3: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"sata3": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_4: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"sata4": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_5: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"sata5": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"sata0": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_1: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"sata1": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_2: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"sata2": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Disk.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_3: &QemuSataStorage{Disk: &QemuSataDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
		...
		{name: "Create Disks.Sata.Disk_X.Passthrough All",
			...
			output: map[string]interface{}{"sata0": "/dev/disk/by-id/scsi-0QEMU_QEMU_HARDDISK_drive-scsi8,aio=threads,cache=unsafe,discard=on,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=test-serial_757465-gdg,ssd=1"},
		},
		...
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_4: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"sata4": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_5: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"sata5": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_0: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"sata0": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_1: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"sata1": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_2: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"sata2": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_3: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"sata3": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Sata.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_4: &QemuSataStorage{Passthrough: &QemuSataPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
		...
		{name: "Create Disks.Scsi.Disk_X.Disk All",
			...
			output: map[string]interface{}{"scsi0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=558485ef-478,ssd=1"},
		},
		...
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_4: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"scsi4": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_5: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"scsi5": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_6: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"scsi6": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_7: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"scsi7": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_8: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"scsi8": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_9: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"scsi9": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Disk.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_10: &QemuScsiStorage{Disk: &QemuScsiDisk{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
		...
		{name: "Create Disks.Scsi.Disk_X.Passthrough All",
			...
			output: map[string]interface{}{"scsi0": "/dev/disk/by-id/scsi-0QEMU_QEMU_HARDDISK_drive-scsi8,aio=threads,cache=unsafe,discard=on,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=test-serial_757465-gdg,ssd=1"},
		},
		...
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_4: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"scsi4": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_5: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"scsi5": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_6: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"scsi6": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_7: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"scsi7": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_8: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"scsi8": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_9: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"scsi9": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.Scsi.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_10: &QemuScsiStorage{Passthrough: &QemuScsiPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
			output: map[string]interface{}{"scsi10": ",backup=0,mbps_wr=45.23,replicate=0"},
		},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk All",
			...
			output: map[string]interface{}{"virtio0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=558485ef-478"},
		},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.ReadLimit",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.ReadLimit.Burst",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.ReadLimit.Concurrent",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.WriteLimit",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.WriteLimit.Burst",
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk.Bandwidth.Data.WriteLimit.Concurrent",
		...
		{name: "Create Disks.VirtIO.Disk_X.Passthrough All",
			...
			output: map[string]interface{}{"virtio0": "/dev/disk/by-id/scsi-0QEMU_QEMU_HARDDISK_drive-scsi8,aio=threads,cache=unsafe,discard=on,iops_rd=34,iops_rd_max=78,iops_wr=23,iops_wr_max=89,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=test-serial_757465-gdg"},
		},
		...
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_4: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{}}}}}}},
			output: map[string]interface{}{"virtio4": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.ReadLimit",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_5: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"virtio5": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_6: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Burst: float99}}}}}}}},
			output: map[string]interface{}{"virtio6": ",backup=0,mbps_rd_max=99.20,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.ReadLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_7: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{ReadLimit: QemuDiskBandwidthDataLimit{Concurrent: float10}}}}}}}},
			output: map[string]interface{}{"virtio7": ",backup=0,mbps_rd=10.30,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.WriteLimit",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_8: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{}}}}}}}},
			output: map[string]interface{}{"virtio8": ",backup=0,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Burst",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_9: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Burst: float79}}}}}}}},
			output: map[string]interface{}{"virtio9": ",backup=0,mbps_wr_max=79.23,replicate=0"},
		},
		{name: "Create Disks.VirtIO.Disk_X.Passthrough.Bandwidth.Data.WriteLimit.Concurrent",
			config: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_10: &QemuVirtIOStorage{Passthrough: &QemuVirtIOPassthrough{Bandwidth: QemuDiskBandwidth{Data: QemuDiskBandwidthData{WriteLimit: QemuDiskBandwidthDataLimit{Concurrent: float45}}}}}}}},
		...
		{name: "Update Disk.Ide.Disk_X.CloudInit SAME",
			...
			output:        map[string]interface{}{"ide0": "test:cloudinit,format=raw"},
		},
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE UP",
			...
			output: map[string]interface{}{"ide3": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE UP LinkedClone",
			...
			output: map[string]interface{}{"ide3": "test:110/base-110-disk-1.raw/0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Ide.Disk_X.Disk SAME",
			...
			output: map[string]interface{}{"ide0": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		...
		{name: "Update Disk.Sata.Disk_X.CloudInit SAME",
			...
			output:        map[string]interface{}{"sata0": "test:cloudinit,format=raw"},
		},
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE UP",
			...
			output: map[string]interface{}{"sata1": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE UP LinkedClone",
			...
			output: map[string]interface{}{"sata1": "test:100/base-100-disk-1.raw/0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Sata.Disk_X.Disk SAME",
			...
			output: map[string]interface{}{"sata2": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		...
		{name: "Update Disk.Scsi.Disk_X.CdRom SAME",
			...
			output:        map[string]interface{}{"scsi8": "cdrom,media=cdrom"},
		},
		...
		{name: "Update Disk.Scsi.Disk_X.CloudInit SAME",
			...
			output:        map[string]interface{}{"scsi12": "test:cloudinit,format=raw"},
		},
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE UP",
			...
			output: map[string]interface{}{"scsi19": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE UP LinkedClone",
			...
			output: map[string]interface{}{"scsi19": "test:100/base-100-disk-1.raw/0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.Scsi.Disk_X.Disk SAME",
			...
			output: map[string]interface{}{"scsi20": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		...
		{name: "Update Disk.VirtIO.Disk_X.CdRom SAME",
			...
			output:        map[string]interface{}{"virtio8": "cdrom,media=cdrom"},
		},
		...
		{name: "Update Disk.VirtIO.Disk_X.CloudInit SAME",
			...
			output:        map[string]interface{}{"virtio12": "test:cloudinit,format=raw"},
		},
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE UP",
			...
			output: map[string]interface{}{"virtio3": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE UP LinkedClone",
			...
			output: map[string]interface{}{"virtio3": "test:100/base-100-disk-1.raw/0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
		{name: "Update Disk.VirtIO.Disk_X.Disk SAME",
			...
			output: map[string]interface{}{"virtio4": "test:0/vm-0-disk-23.raw,backup=0,replicate=0"},
		},
...
func Test_ConfigQemu_mapToStruct(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Disks Ide Disk ALL LinkedClone",
			input: map[string]interface{}{"ide1": "test2:110/base-110-disk-1.qcow2/100/vm-100-disk-53.qcow2,aio=io_uring,backup=0,cache=writethrough,discard=on,iops_rd=12,iops_rd_max=13,iops_wr=15,iops_wr_max=14,mbps_rd=1.46,mbps_rd_max=3.57,mbps_wr=2.68,mbps_wr_max=4.55,replicate=0,serial=disk-9763,size=1032G,ssd=1"},
			output: &ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Disk: &QemuIdeDisk{
				AsyncIO: QemuDiskAsyncIO_IOuring,
				Backup:  false,
				Bandwidth: QemuDiskBandwidth{
		...
		{name: "Disks Sata Disk ALL LinkedClone",
			input: map[string]interface{}{"sata1": "test2:110/base-110-disk-1.qcow2/100/vm-100-disk-47.qcow2,aio=native,backup=0,cache=none,discard=on,iops_rd=10,iops_rd_max=12,iops_wr=11,iops_wr_max=13,mbps_rd=1.51,mbps_rd_max=3.51,mbps_wr=2.51,mbps_wr_max=4.51,replicate=0,serial=disk-9763,size=32G,ssd=1"},
			output: &ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_1: &QemuSataStorage{Disk: &QemuSataDisk{
				AsyncIO: QemuDiskAsyncIO_Native,
				Backup:  false,
				Bandwidth: QemuDiskBandwidth{
		...
		{name: "Disks Scsi Disk ALL LinkedClone",
			input: map[string]interface{}{"scsi1": "test:110/base-110-disk-1.qcow2/100/vm-100-disk-2.qcow2,aio=threads,backup=0,cache=writeback,discard=on,iops_rd=10,iops_rd_max=12,iops_wr=11,iops_wr_max=13,iothread=1,mbps_rd=1.51,mbps_rd_max=3.51,mbps_wr=2.51,mbps_wr_max=4.51,replicate=0,ro=1,serial=disk-9763,size=32G,ssd=1"},
			output: &ConfigQemu{Disks: &QemuStorages{Scsi: &QemuScsiDisks{Disk_1: &QemuScsiStorage{Disk: &QemuScsiDisk{
				AsyncIO: QemuDiskAsyncIO_Threads,
				Backup:  false,
				Bandwidth: QemuDiskBandwidth{
		...
		{name: "Disks VirtIO Disk ALL LinkedClone",
			input: map[string]interface{}{"virtio1": "test2:110/base-110-disk-1.qcow2/100/vm-100-disk-31.qcow2,aio=io_uring,backup=0,cache=directsync,discard=on,iops_rd=10,iops_rd_max=12,iops_wr=11,iops_wr_max=13,iothread=1,mbps_rd=1.51,mbps_rd_max=3.51,mbps_wr=2.51,mbps_wr_max=4.51,replicate=0,ro=1,serial=disk-9763,size=32G"},
			output: &ConfigQemu{Disks: &QemuStorages{VirtIO: &QemuVirtIODisks{Disk_1: &QemuVirtIOStorage{Disk: &QemuVirtIODisk{
				AsyncIO: QemuDiskAsyncIO_IOuring,
				Backup:  false,
				Bandwidth: QemuDiskBandwidth{
...
func Test_ConfigQemu_Validate(t *testing.T) {
	...
	testData := []struct {
		...
		{name: `Invalid Disks Disk Ide errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
			...
			err:   errors.New(Error_QemuDiskBandwidthDataLimitBurst),
		},
		{name: `Invalid Disks Disk Ide errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
			...
			err:   errors.New(Error_QemuDiskBandwidthDataLimitConcurrent),
		},
		{name: `Invalid Disks Disk Ide errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Disk Ide errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Disk Sata errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Disk Sata errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Disk Sata errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Disk Sata errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Disk Scsi errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Disk Scsi errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Disk Scsi errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Disk Scsi errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Disk VirtIO errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Disk VirtIO errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Disk VirtIO errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Disk VirtIO errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Passthrough Ide errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Passthrough Ide errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Passthrough Ide errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Passthrough Ide errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Passthrough Sata errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Passthrough Sata errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Passthrough Sata errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Passthrough Sata errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Passthrough Scsi errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Passthrough Scsi errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Passthrough Scsi errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Passthrough Scsi errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
		...
		{name: `Invalid Disks Passthrough VirtIO errors.New(Error_QemuDiskBandwidthDataLimitBurst) 0`,
		...
		{name: `Invalid Disks Passthrough VirtIO errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 0`,
		...
		{name: `Invalid Disks Passthrough VirtIO errors.New(Error_QemuDiskBandwidthDataLimitBurst) 1`,
		...
		{name: `Invalid Disks Passthrough VirtIO errors.New(Error_QemuDiskBandwidthDataLimitConcurrent) 1`,
