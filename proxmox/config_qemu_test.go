		...
		{category: `CPU`,
			create: []test{
				...
				{name: `Flags SpecCtrl`,
					...
					output: map[string]interface{}{"cpu": ",+spec-ctrl"}},
				{name: `Flags VirtSSBD`,
					config: &ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{VirtSSBD: util.Pointer(TriBoolFalse)}}},
					output: map[string]interface{}{"cpu": ",-virt-ssbd"}},
				{name: `Flags mixed`,
					...
					output: map[string]interface{}{"cpu": ",+aes;-amd-no-ssb;+amd-ssbd;+hv-tlbflush;+md-clear;-pcid"}},
				{name: `Flags all nil`,
					config: &ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{}}},
					output: map[string]interface{}{}},
				{name: `Flags all none`,
			...
			update: []test{
				...
				{name: `Flags nil`,
					...
					currentConfig: ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{
						AES:  util.Pointer(TriBoolTrue),
						PCID: util.Pointer(TriBoolFalse)}}},
					output: map[string]interface{}{"cpu": ",+aes;-pcid"}},
				{name: `Flags`,
					config: &ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{
						AES:        util.Pointer(TriBoolTrue),
						AmdNoSSB:   util.Pointer(TriBoolNone),
					...
					currentConfig: ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{
						...
						MdClear:    util.Pointer(TriBoolTrue),
						SpecCtrl:   util.Pointer(TriBoolFalse)}}},
					output: map[string]interface{}{"cpu": ",+aes;-hv-evmcs;+hv-tlbflush;-md-clear;+pcid;-spec-ctrl;-virt-ssbd"}},
				{name: `Flags all none`,
					config: &ConfigQemu{CPU: &QemuCPU{Flags: &CpuFlags{
						AES:        util.Pointer(TriBoolNone),
						AmdNoSSB:   util.Pointer(TriBoolNone),
				...
				{name: `Flags & Type, update Flags`,
					...
					currentConfig: ConfigQemu{CPU: &QemuCPU{
						Flags: &CpuFlags{
							...
							SpecCtrl:   util.Pointer(TriBoolFalse)},
						Type: util.Pointer(CpuType_Host)}},
					output: map[string]interface{}{"cpu": "host,+amd-no-ssb;-hv-evmcs;-hv-tlbflush;+ibpb;+md-clear;-spec-ctrl"}},
				{name: `Flags & Type, update Type`,
					...
					currentConfig: ConfigQemu{CPU: &QemuCPU{
						...
						Type: util.Pointer(CpuType_Host)}},
					version: Version{}.max(),
					output:  map[string]interface{}{"cpu": "x86-64-v2-AES,-hv-evmcs;-hv-tlbflush;+ibpb;+md-clear;-spec-ctrl"}},
				{name: `Limit 0`,
					config:        &ConfigQemu{CPU: &QemuCPU{Limit: util.Pointer(CpuLimit(0))}},
					currentConfig: ConfigQemu{CPU: &QemuCPU{Limit: util.Pointer(CpuLimit(100))}},
			...
			tests: []test{
				{name: `all`,
					input: map[string]interface{}{
						...
						"sockets":  float64(4),
						"vcpus":    float64(40),
						"cpu":      string("host,-aes;+amd-no-ssb;-amd-ssbd;+hv-evmcs;-hv-tlbflush;+ibpb;+md-clear;-pcid;-pdpe1gb;-ssbd;+spec-ctrl;+virt-ssbd")},
				...
				{name: `cpu with flags`,
					input: map[string]interface{}{"cpu": "x86-64-v2-AES,+spec-ctrl;-md-clear"},
					output: baseConfig(ConfigQemu{CPU: &QemuCPU{
						Flags: &CpuFlags{
							MdClear:  util.Pointer(TriBoolFalse),
							SpecCtrl: util.Pointer(TriBoolTrue)},
